...
export declare const ShipCrewRotationEnum: {
    readonly Strict: "STRICT";
    readonly Relaxed: "RELAXED";
};
export declare type ShipCrewRotationEnum = typeof ShipCrewRotationEnum[keyof typeof ShipCrewRotationEnum];
//# sourceMappingURL=ship-crew.d.ts.map