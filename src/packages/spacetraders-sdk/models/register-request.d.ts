...
export declare const RegisterRequestFactionEnum: {
    readonly Cosmic: "COSMIC";
    readonly Void: "VOID";
    readonly Galactic: "GALACTIC";
    readonly Quantum: "QUANTUM";
    readonly Dominion: "DOMINION";
};
export declare type RegisterRequestFactionEnum = typeof RegisterRequestFactionEnum[keyof typeof RegisterRequestFactionEnum];
